...
use zktlsn::{
    Proof, RECURSIVE_PUBLIC_INPUTS, RecursiveSettlement, aggregate_attestations,
...
pub fn prepare_settlement_artifacts(
    ...
    artifacts::write_generated_artifacts(&repo_root)
